import click                            #we import all necessary packages and modules
import numpy as np  
import pandas as pd  
import logging  
...
class MagneticAdjointSolver:
    ...
    def solve(self, mesh: Mesh, magnetic_properties: MagneticProperties): # takes mesh obj and magnetic properties as input
        ...
        rho_sus = np.zeros((10000000), dtype="float32") #here we are going to create several arrays for magnetic inverse
